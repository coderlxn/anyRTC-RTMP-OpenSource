...
#ifndef WEBRTC_AUDIO_DEVICE_AUDIO_CAPTURE_CORE_WIN_H_
#define WEBRTC_AUDIO_DEVICE_AUDIO_CAPTURE_CORE_WIN_H_
...
namespace webrtc {
	...
	class AudioCaptureCore : public AudioDeviceGeneric
	{
	public:
		AudioCaptureCore(const int32_t id);
		~AudioCaptureCore();
	...
	private:  // WASAPI
		IAudioClient*                           _ptrClientOut;
                IAudioClient*                           _ptrAudioClientIn;
