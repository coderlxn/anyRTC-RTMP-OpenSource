...
#include "audio_capture_core_win.h"
...
bool AudioCaptureWindowsCore::CoreAudioIsSupported()
{
    ...
    if (FAILED(hr))
    {
        WEBRTC_TRACE(kTraceError, kTraceAudioDevice, -1,
            "AudioCaptureWindowsCore::CoreAudioIsSupported() Failed to create the required COM object", hr);
        WEBRTC_TRACE(kTraceInfo, kTraceAudioDevice, -1,
            "AudioCaptureWindowsCore::CoreAudioIsSupported() CoCreateInstance(MMDeviceEnumerator) failed (hr=0x%x)", hr);
    ...
    else
    {
        ...
        WEBRTC_TRACE(kTraceInfo, kTraceAudioDevice, -1,
            "AudioCaptureWindowsCore::CoreAudioIsSupported() CoCreateInstance(MMDeviceEnumerator) succeeded", hr);
        SAFE_RELEASE(pIMMD);
    }
    ...
    if (MMDeviceIsAvailable)
    {
        ...
        AudioCaptureWindowsCore* p = new AudioCaptureWindowsCore(-1);
        if (p == NULL)
        {
            return false;
        }
        ...
        for (uint16_t i = 0; i < numDevsRec; i++)
        {
            ...
            if (ok)
            {
                WEBRTC_TRACE(kTraceWarning, kTraceAudioDevice, -1,
                    "AudioCaptureWindowsCore::CoreAudioIsSupported() Failed to use Core Audio Recording for device id=%i", i);
            }
        }
        ...
        for (uint16_t i = 0; i < numDevsPlay; i++)
        {
            ...
            {
                WEBRTC_TRACE(kTraceWarning, kTraceAudioDevice, -1 ,
                    "AudioCaptureWindowsCore::CoreAudioIsSupported() Failed to use Core Audio Playout for device id=%i", i);
            }
        }*/
...
// ----------------------------------------------------------------------------
//  AudioCaptureWindowsCore() - ctor
// ----------------------------------------------------------------------------

AudioCaptureWindowsCore::AudioCaptureWindowsCore(const int32_t id) :
    ...
    _newMicLevel(0)
{
    ...
    if (!_avrtLibrary)
    {
        ...
        if (_avrtLibrary)
        {
            ...
            WEBRTC_TRACE(kTraceInfo, kTraceAudioDevice, _id, "AudioCaptureWindowsCore::AudioCaptureWindowsCore() The Avrt DLL module is now loaded");
            ...
            {
                WEBRTC_TRACE(kTraceInfo, kTraceAudioDevice, _id, "AudioCaptureWindowsCore::AudioCaptureWindowsCore() AvRevertMmThreadCharacteristics() is OK");
                WEBRTC_TRACE(kTraceInfo, kTraceAudioDevice, _id, "AudioCaptureWindowsCore::AudioCaptureWindowsCore() AvSetMmThreadCharacteristicsA() is OK");
                WEBRTC_TRACE(kTraceInfo, kTraceAudioDevice, _id, "AudioCaptureWindowsCore::AudioCaptureWindowsCore() AvSetMmThreadPriority() is OK");
...
// ----------------------------------------------------------------------------
//  AudioCaptureWindowsCore() - dtor
// ----------------------------------------------------------------------------

AudioCaptureWindowsCore::~AudioCaptureWindowsCore()
{
    ...
    if (_avrtLibrary)
    {
        ...
        if (!freeOK)
        {
            WEBRTC_TRACE(kTraceWarning, kTraceAudioDevice, _id,
                "AudioCaptureWindowsCore::~AudioCaptureWindowsCore() failed to free the loaded Avrt DLL module correctly");
        }
        else
        {
            WEBRTC_TRACE(kTraceWarning, kTraceAudioDevice, _id,
                "AudioCaptureWindowsCore::~AudioCaptureWindowsCore() the Avrt DLL module is now unloaded");
        }
    }
...
void AudioCaptureWindowsCore::AttachAudioBuffer(AudioDeviceBuffer* audioBuffer)
{
...
int32_t AudioCaptureWindowsCore::ActiveAudioLayer(AudioDeviceModule::AudioLayer& audioLayer) const
{
...
int32_t AudioCaptureWindowsCore::Init()
{
...
int32_t AudioCaptureWindowsCore::Terminate()
{
...
bool AudioCaptureWindowsCore::Initialized() const
{
    return (_initialized);
}
...
int32_t AudioCaptureWindowsCore::InitSpeaker()
{
...
int32_t AudioCaptureWindowsCore::InitMicrophone()
{
    ...
    if (_usingInputDeviceIndex)
    {
        ...
        ret = _GetListDevice(eRender, _inputDeviceIndex, &_ptrDeviceIn);
    }
    else
    {
        ERole role;
        ...
        ret = _GetDefaultDevice(eRender, role, &_ptrDeviceIn);
    }
...
bool AudioCaptureWindowsCore::SpeakerIsInitialized() const
{
...
bool AudioCaptureWindowsCore::MicrophoneIsInitialized() const
{
...
int32_t AudioCaptureWindowsCore::SpeakerVolumeIsAvailable(bool& available)
{
...
int32_t AudioCaptureWindowsCore::SetSpeakerVolume(uint32_t volume)
{
...
int32_t AudioCaptureWindowsCore::SpeakerVolume(uint32_t& volume) const
{
...
int32_t AudioCaptureWindowsCore::SetWaveOutVolume(uint16_t volumeLeft, uint16_t volumeRight)
{
    return -1;
}
...
int32_t AudioCaptureWindowsCore::WaveOutVolume(uint16_t& volumeLeft, uint16_t& volumeRight) const
{
    return -1;
}
...
int32_t AudioCaptureWindowsCore::MaxSpeakerVolume(uint32_t& maxVolume) const
{
...
int32_t AudioCaptureWindowsCore::MinSpeakerVolume(uint32_t& minVolume) const
{
...
int32_t AudioCaptureWindowsCore::SpeakerVolumeStepSize(uint16_t& stepSize) const
{
...
int32_t AudioCaptureWindowsCore::SpeakerMuteIsAvailable(bool& available)
{
...
int32_t AudioCaptureWindowsCore::SetSpeakerMute(bool enable)
{
...
int32_t AudioCaptureWindowsCore::SpeakerMute(bool& enabled) const
{
...
int32_t AudioCaptureWindowsCore::MicrophoneMuteIsAvailable(bool& available)
{
...
int32_t AudioCaptureWindowsCore::SetMicrophoneMute(bool enable)
{
...
int32_t AudioCaptureWindowsCore::MicrophoneMute(bool& enabled) const
{
...
int32_t AudioCaptureWindowsCore::MicrophoneBoostIsAvailable(bool& available)
{
...
int32_t AudioCaptureWindowsCore::SetMicrophoneBoost(bool enable)
{
...
int32_t AudioCaptureWindowsCore::MicrophoneBoost(bool& enabled) const
{
...
int32_t AudioCaptureWindowsCore::StereoRecordingIsAvailable(bool& available)
{
...
int32_t AudioCaptureWindowsCore::SetStereoRecording(bool enable)
{
...
int32_t AudioCaptureWindowsCore::StereoRecording(bool& enabled) const
{
...
int32_t AudioCaptureWindowsCore::StereoPlayoutIsAvailable(bool& available)
{
...
int32_t AudioCaptureWindowsCore::SetStereoPlayout(bool enable)
{
...
int32_t AudioCaptureWindowsCore::StereoPlayout(bool& enabled) const
{
...
int32_t AudioCaptureWindowsCore::SetAGC(bool enable)
{
    CriticalSectionScoped lock(&_critSect);
    _AGC = enable;
    return 0;
...
bool AudioCaptureWindowsCore::AGC() const
{
    CriticalSectionScoped lock(&_critSect);
    return _AGC;
}
...
int32_t AudioCaptureWindowsCore::MicrophoneVolumeIsAvailable(bool& available)
{
...
int32_t AudioCaptureWindowsCore::SetMicrophoneVolume(uint32_t volume)
{
    WEBRTC_TRACE(kTraceStream, kTraceAudioDevice, _id, "AudioCaptureWindowsCore::SetMicrophoneVolume(volume=%u)", volume);
...
int32_t AudioCaptureWindowsCore::MicrophoneVolume(uint32_t& volume) const
{
    {
        CriticalSectionScoped lock(&_critSect);
...
int32_t AudioCaptureWindowsCore::MaxMicrophoneVolume(uint32_t& maxVolume) const
{
...
int32_t AudioCaptureWindowsCore::MinMicrophoneVolume(uint32_t& minVolume) const
{
...
int32_t AudioCaptureWindowsCore::MicrophoneVolumeStepSize(uint16_t& stepSize) const
{
...
int16_t AudioCaptureWindowsCore::PlayoutDevices()
{
...
int32_t AudioCaptureWindowsCore::SetPlayoutDevice(uint16_t index)
{
...
int32_t AudioCaptureWindowsCore::SetPlayoutDevice(AudioDeviceModule::WindowsDeviceType device)
{
    if (_playIsInitialized)
    {
        return -1;
...
int32_t AudioCaptureWindowsCore::PlayoutDeviceName(
    uint16_t index,
...
int32_t AudioCaptureWindowsCore::RecordingDeviceName(
    uint16_t index,
    char name[kAdmMaxDeviceNameSize],
    char guid[kAdmMaxGuidSize])
{
    ...
    if (defaultCommunicationDevice)
    {
        ret = _GetDefaultDeviceName(eRender, eConsole, szDeviceName, bufferLen);
    }
    else
    {
        ret = _GetListDeviceName(eRender, index, szDeviceName, bufferLen);
    ...
    if (defaultCommunicationDevice)
    {
        ret = _GetDefaultDeviceID(eRender, eConsole, szDeviceName, bufferLen);
    }
    else
    {
        ret = _GetListDeviceID(eRender, index, szDeviceName, bufferLen);
...
int16_t AudioCaptureWindowsCore::RecordingDevices()
{
...
int32_t AudioCaptureWindowsCore::SetRecordingDevice(uint16_t index)
{
...
int32_t AudioCaptureWindowsCore::SetRecordingDevice(AudioDeviceModule::WindowsDeviceType device)
{
    if (_recIsInitialized)
    {
        return -1;
...
int32_t AudioCaptureWindowsCore::PlayoutIsAvailable(bool& available)
{
...
int32_t AudioCaptureWindowsCore::RecordingIsAvailable(bool& available)
{
...
int32_t AudioCaptureWindowsCore::InitPlayout()
{
...
int32_t AudioCaptureWindowsCore::InitRecordingDMO()
{
...
int32_t AudioCaptureWindowsCore::InitRecording()
{
    ...
    hr = _ptrClientIn->Initialize(
                          AUDCLNT_SHAREMODE_SHARED,             // share Audio Engine with other applications
                          AUDCLNT_STREAMFLAGS_LOOPBACK,        // volume and mute settings for an audio session will not persist across system restarts
                          10000000,                                    // required for event-driven shared mode
                          0,                                    // periodicity
                          &Wfx,                                 // selected wave format
                          NULL);                                // session GUID
...
int32_t AudioCaptureWindowsCore::StartRecording()
{
...
int32_t AudioCaptureWindowsCore::StopRecording()
{
    int32_t err = 0;
...
bool AudioCaptureWindowsCore::RecordingIsInitialized() const
{
...
bool AudioCaptureWindowsCore::Recording() const
{
    return (_recording);
}
...
bool AudioCaptureWindowsCore::PlayoutIsInitialized() const
{
...
int32_t AudioCaptureWindowsCore::StartPlayout()
{
...
int32_t AudioCaptureWindowsCore::StopPlayout()
{
...
int32_t AudioCaptureWindowsCore::PlayoutDelay(uint16_t& delayMS) const
{
    CriticalSectionScoped critScoped(&_critSect);
...
int32_t AudioCaptureWindowsCore::RecordingDelay(uint16_t& delayMS) const
{
    CriticalSectionScoped critScoped(&_critSect);
...
bool AudioCaptureWindowsCore::Playing() const
{
    return (_playing);
}
// ----------------------------------------------------------------------------
...
int32_t AudioCaptureWindowsCore::SetPlayoutBuffer(const AudioDeviceModule::BufferType type, uint16_t sizeMS)
{
...
int32_t AudioCaptureWindowsCore::PlayoutBuffer(AudioDeviceModule::BufferType& type, uint16_t& sizeMS) const
{
    CriticalSectionScoped lock(&_critSect);
    type = _playBufType;
...
int32_t AudioCaptureWindowsCore::CPULoad(uint16_t& load) const
{
...
bool AudioCaptureWindowsCore::PlayoutWarning() const
{
...
bool AudioCaptureWindowsCore::PlayoutError() const
{
    return ( _playError > 0);
}
...
bool AudioCaptureWindowsCore::RecordingWarning() const
{
...
bool AudioCaptureWindowsCore::RecordingError() const
{
    return ( _recError > 0);
}
...
void AudioCaptureWindowsCore::ClearPlayoutWarning()
{
    _playWarning = 0;
}
...
void AudioCaptureWindowsCore::ClearPlayoutError()
{
    _playError = 0;
}
...
void AudioCaptureWindowsCore::ClearRecordingWarning()
{
    _recWarning = 0;
}
...
void AudioCaptureWindowsCore::ClearRecordingError()
{
    _recError = 0;
}
...
DWORD WINAPI AudioCaptureWindowsCore::WSAPIRenderThread(LPVOID context)
{
    return reinterpret_cast<AudioCaptureWindowsCore*>(context)->
        DoRenderThread();
}
...
DWORD WINAPI AudioCaptureWindowsCore::WSAPICaptureThread(LPVOID context)
{
    return reinterpret_cast<AudioCaptureWindowsCore*>(context)->
        DoCaptureThread();
}

DWORD WINAPI AudioCaptureWindowsCore::WSAPICaptureThreadPollDMO(LPVOID context)
{
    return reinterpret_cast<AudioCaptureWindowsCore*>(context)->
        DoCaptureThreadPollDMO();
}

DWORD WINAPI AudioCaptureWindowsCore::GetCaptureVolumeThread(LPVOID context)
{
    return reinterpret_cast<AudioCaptureWindowsCore*>(context)->
        DoGetCaptureVolumeThread();
}

DWORD WINAPI AudioCaptureWindowsCore::SetCaptureVolumeThread(LPVOID context)
{
    return reinterpret_cast<AudioCaptureWindowsCore*>(context)->
        DoSetCaptureVolumeThread();
}

DWORD AudioCaptureWindowsCore::DoGetCaptureVolumeThread()
{
...
DWORD AudioCaptureWindowsCore::DoSetCaptureVolumeThread()
{
...
DWORD AudioCaptureWindowsCore::DoRenderThread()
{
...
DWORD AudioCaptureWindowsCore::InitCaptureThreadPriority()
{
    _hMmTask = NULL;
...
void AudioCaptureWindowsCore::RevertCaptureThreadPriority()
{
    if (_winSupportAvrt)
    {
        if (NULL != _hMmTask)
...
DWORD AudioCaptureWindowsCore::DoCaptureThreadPollDMO()
{
...
DWORD AudioCaptureWindowsCore::DoCaptureThread()
{
...
int32_t AudioCaptureWindowsCore::EnableBuiltInAEC(bool enable)
{
...
bool AudioCaptureWindowsCore::BuiltInAECIsEnabled() const
{
    return _builtInAecEnabled;
}

int AudioCaptureWindowsCore::SetDMOProperties()
{
    HRESULT hr = S_OK;
    assert(_dmo != NULL);
...
int AudioCaptureWindowsCore::SetBoolProperty(IPropertyStore* ptrPS,
                                            REFPROPERTYKEY key,
                                            VARIANT_BOOL value)
{
    PROPVARIANT pv;
...
int AudioCaptureWindowsCore::SetVtI4Property(IPropertyStore* ptrPS,
                                            REFPROPERTYKEY key,
                                            LONG value)
{
    PROPVARIANT pv;
...
int32_t AudioCaptureWindowsCore::_RefreshDeviceList(EDataFlow dir)
{
...
int16_t AudioCaptureWindowsCore::_DeviceListCount(EDataFlow dir)
{
    WEBRTC_TRACE(kTraceInfo, kTraceAudioDevice, _id, "%s", __FUNCTION__);
...
int32_t AudioCaptureWindowsCore::_GetListDeviceName(EDataFlow dir, int index, LPWSTR szBuffer, int bufferLen)
{
    WEBRTC_TRACE(kTraceInfo, kTraceAudioDevice, _id, "%s", __FUNCTION__);
...
int32_t AudioCaptureWindowsCore::_GetDefaultDeviceName(EDataFlow dir, ERole role, LPWSTR szBuffer, int bufferLen)
{
    WEBRTC_TRACE(kTraceInfo, kTraceAudioDevice, _id, "%s", __FUNCTION__);
...
int32_t AudioCaptureWindowsCore::_GetListDeviceID(EDataFlow dir, int index, LPWSTR szBuffer, int bufferLen)
{
    WEBRTC_TRACE(kTraceInfo, kTraceAudioDevice, _id, "%s", __FUNCTION__);
...
int32_t AudioCaptureWindowsCore::_GetDefaultDeviceID(EDataFlow dir, ERole role, LPWSTR szBuffer, int bufferLen)
{
    WEBRTC_TRACE(kTraceInfo, kTraceAudioDevice, _id, "%s", __FUNCTION__);
...
int32_t AudioCaptureWindowsCore::_GetDefaultDeviceIndex(EDataFlow dir,
                                                       ERole role,
                                                       int* index)
{
    WEBRTC_TRACE(kTraceInfo, kTraceAudioDevice, _id, "%s", __FUNCTION__);
...
int32_t AudioCaptureWindowsCore::_GetDeviceName(IMMDevice* pDevice,
                                               LPWSTR pszBuffer,
                                               int bufferLen)
{
    WEBRTC_TRACE(kTraceInfo, kTraceAudioDevice, _id, "%s", __FUNCTION__);
...
int32_t AudioCaptureWindowsCore::_GetDeviceID(IMMDevice* pDevice, LPWSTR pszBuffer, int bufferLen)
{
    WEBRTC_TRACE(kTraceInfo, kTraceAudioDevice, _id, "%s", __FUNCTION__);
...
int32_t AudioCaptureWindowsCore::_GetDefaultDevice(EDataFlow dir, ERole role, IMMDevice** ppDevice)
{
    WEBRTC_TRACE(kTraceInfo, kTraceAudioDevice, _id, "%s", __FUNCTION__);
...
int32_t AudioCaptureWindowsCore::_GetListDevice(EDataFlow dir, int index, IMMDevice** ppDevice)
{
    HRESULT hr(S_OK);
...
int32_t AudioCaptureWindowsCore::_EnumerateEndpointDevicesAll(EDataFlow dataFlow) const
{
    WEBRTC_TRACE(kTraceInfo, kTraceAudioDevice, _id, "%s", __FUNCTION__);
...
void AudioCaptureWindowsCore::_TraceCOMError(HRESULT hr) const
{
    TCHAR buf[MAXERRORLENGTH];
    TCHAR errorText[MAXERRORLENGTH];
...
char* AudioCaptureWindowsCore::WideToUTF8(const TCHAR* src) const {
#ifdef UNICODE
...
bool AudioCaptureWindowsCore::KeyPressed() const{
