...
class AudioCaptureModuleImpl : public AudioDeviceModule {
 public:
  enum PlatformType {
  ...
  AudioCaptureModuleImpl(const int32_t id, const AudioLayer audioLayer);
  virtual ~AudioCaptureModuleImpl();
