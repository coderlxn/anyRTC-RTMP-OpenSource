...
#ifndef WEBRTC_AUDIO_DEVICE_AUDIO_CAPTURE_IMPL_H
#define WEBRTC_AUDIO_DEVICE_AUDIO_CAPTURE_IMPL_H


#if defined(WEBRTC_AUDIO_DEVICE_AUDIO_CAPTURE_IMPL_H)
...
namespace webrtc {
	...
	public:
		...
		static rtc::scoped_refptr<AudioDeviceModule> NewCreate(
			const int32_t id,
		...
		AudioCaptureModule(const int32_t id, const AudioLayer audioLayer);
