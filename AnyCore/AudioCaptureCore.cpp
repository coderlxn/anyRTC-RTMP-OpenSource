...
namespace webrtc {
	...
	bool AudioCaptureCore::CoreAudioIsSupported()
	{
            return true;
	}
	...
	// ----------------------------------------------------------------------------
	//  AudioCaptureCore() - ctor
	// ----------------------------------------------------------------------------

	AudioCaptureCore::AudioCaptureCore(const int32_t id) :
		...
		_newMicLevel(0)
	{
		...
		if (!_avrtLibrary)
		{
			...
			if (_avrtLibrary)
			{
				...
				WEBRTC_TRACE(kTraceInfo, kTraceAudioDevice, _id, "AudioCaptureCore::AudioCaptureCore() The Avrt DLL module is now loaded");
				...
				{
					WEBRTC_TRACE(kTraceInfo, kTraceAudioDevice, _id, "AudioCaptureCore::AudioCaptureCore() AvRevertMmThreadCharacteristics() is OK");
					WEBRTC_TRACE(kTraceInfo, kTraceAudioDevice, _id, "AudioCaptureCore::AudioCaptureCore() AvSetMmThreadCharacteristicsA() is OK");
					WEBRTC_TRACE(kTraceInfo, kTraceAudioDevice, _id, "AudioCaptureCore::AudioCaptureCore() AvSetMmThreadPriority() is OK");
		...
		if (_avrtLibrary)
		{
			...
			if (!freeOK)
			{
				WEBRTC_TRACE(kTraceWarning, kTraceAudioDevice, _id,
					"AudioCaptureCore::~AudioCaptureCore() failed to free the loaded Avrt DLL module correctly");
			}
			else
			{
				WEBRTC_TRACE(kTraceWarning, kTraceAudioDevice, _id,
					"AudioCaptureCore::~AudioCaptureCore() the Avrt DLL module is now unloaded");
			}
		}
	...
	void AudioCaptureCore::AttachAudioBuffer(AudioDeviceBuffer* audioBuffer)
	{
	...
	int32_t AudioCaptureCore::ActiveAudioLayer(AudioDeviceModule::AudioLayer& audioLayer) const
	{
	...
	int32_t AudioCaptureCore::Terminate()
	{
		...
		SAFE_RELEASE(_ptrClientOut);
                SAFE_RELEASE(_ptrAudioClientIn);
	...
	bool AudioCaptureCore::Initialized() const
	{
		return (_initialized);
	}
	...
	int32_t AudioCaptureCore::InitSpeaker()
	{
	...
	int32_t AudioCaptureCore::InitMicrophone()
	{
	...
	bool AudioCaptureCore::SpeakerIsInitialized() const
	{
	...
	bool AudioCaptureCore::MicrophoneIsInitialized() const
	{
	...
	int32_t AudioCaptureCore::SpeakerVolumeIsAvailable(bool& available)
	{
	...
	int32_t AudioCaptureCore::SetSpeakerVolume(uint32_t volume)
	{
	...
	int32_t AudioCaptureCore::SpeakerVolume(uint32_t& volume) const
	{
	...
	int32_t AudioCaptureCore::SetWaveOutVolume(uint16_t volumeLeft, uint16_t volumeRight)
	{
		return -1;
	}
	...
	int32_t AudioCaptureCore::WaveOutVolume(uint16_t& volumeLeft, uint16_t& volumeRight) const
	{
		return -1;
	}
	...
	int32_t AudioCaptureCore::MaxSpeakerVolume(uint32_t& maxVolume) const
	{
	...
	int32_t AudioCaptureCore::MinSpeakerVolume(uint32_t& minVolume) const
	{
	...
	int32_t AudioCaptureCore::SpeakerVolumeStepSize(uint16_t& stepSize) const
	{
	...
	int32_t AudioCaptureCore::SpeakerMuteIsAvailable(bool& available)
	{
	...
	int32_t AudioCaptureCore::SetSpeakerMute(bool enable)
	{
	...
	int32_t AudioCaptureCore::SpeakerMute(bool& enabled) const
	{
	...
	int32_t AudioCaptureCore::MicrophoneMuteIsAvailable(bool& available)
	{
	...
	int32_t AudioCaptureCore::SetMicrophoneMute(bool enable)
	{
	...
	int32_t AudioCaptureCore::MicrophoneMute(bool& enabled) const
	{
	...
	int32_t AudioCaptureCore::MicrophoneBoostIsAvailable(bool& available)
	{
	...
	int32_t AudioCaptureCore::SetMicrophoneBoost(bool enable)
	{
	...
	int32_t AudioCaptureCore::MicrophoneBoost(bool& enabled) const
	{
	...
	int32_t AudioCaptureCore::StereoRecordingIsAvailable(bool& available)
	{
	...
	int32_t AudioCaptureCore::SetStereoRecording(bool enable)
	{
	...
	int32_t AudioCaptureCore::StereoRecording(bool& enabled) const
	{
	...
	int32_t AudioCaptureCore::StereoPlayoutIsAvailable(bool& available)
	{
	...
	int32_t AudioCaptureCore::SetStereoPlayout(bool enable)
	{
	...
	int32_t AudioCaptureCore::StereoPlayout(bool& enabled) const
	{
	...
	int32_t AudioCaptureCore::SetAGC(bool enable)
	{
		CriticalSectionScoped lock(&_critSect);
		_AGC = enable;
		return 0;
	...
	bool AudioCaptureCore::AGC() const
	{
		CriticalSectionScoped lock(&_critSect);
		return _AGC;
	}
	...
	int32_t AudioCaptureCore::MicrophoneVolumeIsAvailable(bool& available)
	{
	...
	int32_t AudioCaptureCore::SetMicrophoneVolume(uint32_t volume)
	{
		WEBRTC_TRACE(kTraceStream, kTraceAudioDevice, _id, "AudioCaptureCore::SetMicrophoneVolume(volume=%u)", volume);
	...
	int32_t AudioCaptureCore::MicrophoneVolume(uint32_t& volume) const
	{
		{
			CriticalSectionScoped lock(&_critSect);
	...
	int32_t AudioCaptureCore::MaxMicrophoneVolume(uint32_t& maxVolume) const
	{
	...
	int32_t AudioCaptureCore::MinMicrophoneVolume(uint32_t& minVolume) const
	{
	...
	int32_t AudioCaptureCore::MicrophoneVolumeStepSize(uint16_t& stepSize) const
	{
	...
	int16_t AudioCaptureCore::PlayoutDevices()
	{
	...
	int32_t AudioCaptureCore::SetPlayoutDevice(uint16_t index)
	{
	...
	int32_t AudioCaptureCore::SetPlayoutDevice(AudioDeviceModule::WindowsDeviceType device)
	{
		if (_playIsInitialized)
		{
			return -1;
	...
	int32_t AudioCaptureCore::PlayoutDeviceName(
		uint16_t index,
	...
	int32_t AudioCaptureCore::RecordingDeviceName(
		uint16_t index,
		char name[kAdmMaxDeviceNameSize],
		char guid[kAdmMaxGuidSize])
	{
	...
	int16_t AudioCaptureCore::RecordingDevices()
	{
	...
	int32_t AudioCaptureCore::SetRecordingDevice(uint16_t index)
	{
	...
	int32_t AudioCaptureCore::SetRecordingDevice(AudioDeviceModule::WindowsDeviceType device)
        {
            return 0;
	}
	...
	int32_t AudioCaptureCore::PlayoutIsAvailable(bool& available)
	{
	...
	int32_t AudioCaptureCore::RecordingIsAvailable(bool& available)
	{
	...
	int32_t AudioCaptureCore::InitPlayout()
	{
	...
	int32_t AudioCaptureCore::InitRecordingDMO()
	{
	...
	int32_t AudioCaptureCore::InitRecording()
	{
	...
	int32_t AudioCaptureCore::StartRecording()
	{
		if (_hRecThread != NULL)
		{
			return 0;
	...
	int32_t AudioCaptureCore::StopRecording()
	{
		...
		ResetEvent(_hShutdownCaptureEvent); // Must be manually reset.
                ...
                assert(err == -1 || _ptrAudioClientIn == NULL);
	...
	bool AudioCaptureCore::RecordingIsInitialized() const
	{
	...
	bool AudioCaptureCore::Recording() const
	{
		return (_recording);
	}
	...
	bool AudioCaptureCore::PlayoutIsInitialized() const
	{
	...
	int32_t AudioCaptureCore::StartPlayout()
	{
	...
	int32_t AudioCaptureCore::StopPlayout()
	{
	...
	int32_t AudioCaptureCore::PlayoutDelay(uint16_t& delayMS) const
	{
		CriticalSectionScoped critScoped(&_critSect);
	...
	int32_t AudioCaptureCore::RecordingDelay(uint16_t& delayMS) const
	{
		CriticalSectionScoped critScoped(&_critSect);
	...
	bool AudioCaptureCore::Playing() const
	{
		return (_playing);
	}
	// ----------------------------------------------------------------------------
	...
	int32_t AudioCaptureCore::SetPlayoutBuffer(const AudioDeviceModule::BufferType type, uint16_t sizeMS)
	{
	...
	int32_t AudioCaptureCore::PlayoutBuffer(AudioDeviceModule::BufferType& type, uint16_t& sizeMS) const
	{
		CriticalSectionScoped lock(&_critSect);
		type = _playBufType;
	...
	int32_t AudioCaptureCore::CPULoad(uint16_t& load) const
	{
	...
	bool AudioCaptureCore::PlayoutWarning() const
	{
	...
	bool AudioCaptureCore::PlayoutError() const
	{
		return (_playError > 0);
	}
	...
	bool AudioCaptureCore::RecordingWarning() const
	{
	...
	bool AudioCaptureCore::RecordingError() const
	{
		return (_recError > 0);
	}
	...
	void AudioCaptureCore::ClearPlayoutWarning()
	{
		_playWarning = 0;
	}
	...
	void AudioCaptureCore::ClearPlayoutError()
	{
		_playError = 0;
	}
	...
	void AudioCaptureCore::ClearRecordingWarning()
	{
		_recWarning = 0;
	}
	...
	void AudioCaptureCore::ClearRecordingError()
	{
		_recError = 0;
	}
	...
	DWORD WINAPI AudioCaptureCore::WSAPIRenderThread(LPVOID context)
	{
		return reinterpret_cast<AudioCaptureCore*>(context)->
			DoRenderThread();
	}
	...
	DWORD WINAPI AudioCaptureCore::WSAPICaptureThread(LPVOID context)
	{
		return reinterpret_cast<AudioCaptureCore*>(context)->
			DoCaptureThread();
	}

	DWORD WINAPI AudioCaptureCore::WSAPICaptureThreadPollDMO(LPVOID context)
	{
		return reinterpret_cast<AudioCaptureCore*>(context)->
			DoCaptureThreadPollDMO();
	}

	DWORD WINAPI AudioCaptureCore::GetCaptureVolumeThread(LPVOID context)
	{
		return reinterpret_cast<AudioCaptureCore*>(context)->
			DoGetCaptureVolumeThread();
	}

	DWORD WINAPI AudioCaptureCore::SetCaptureVolumeThread(LPVOID context)
	{
		return reinterpret_cast<AudioCaptureCore*>(context)->
			DoSetCaptureVolumeThread();
	}

	DWORD AudioCaptureCore::DoGetCaptureVolumeThread()
	{
	...
	DWORD AudioCaptureCore::DoSetCaptureVolumeThread()
	{
	...
	DWORD AudioCaptureCore::DoRenderThread()
	{
	...
	DWORD AudioCaptureCore::InitCaptureThreadPriority()
	{
		_hMmTask = NULL;
	...
	void AudioCaptureCore::RevertCaptureThreadPriority()
	{
		if (_winSupportAvrt)
		{
			if (NULL != _hMmTask)
	...
	DWORD AudioCaptureCore::DoCaptureThreadPollDMO()
	{
  ...
  //              SAFE_RELEASE(_ptrAudioClientIn);
	...
	int32_t AudioCaptureCore::EnableBuiltInAEC(bool enable)
	{
	...
	bool AudioCaptureCore::BuiltInAECIsEnabled() const
	{
		return _builtInAecEnabled;
	}

	int AudioCaptureCore::SetDMOProperties()
	{
		HRESULT hr = S_OK;
		assert(_dmo != NULL);
		...
		if (!_usingInputDeviceIndex)
		{
			...
			if (_GetDefaultDeviceIndex(eRender, role, &inDevIndex) == -1)
			{
				return -1;
			}
		}
	...
	int AudioCaptureCore::SetBoolProperty(IPropertyStore* ptrPS,
		REFPROPERTYKEY key,
		VARIANT_BOOL value)
	{
		PROPVARIANT pv;
	...
	int AudioCaptureCore::SetVtI4Property(IPropertyStore* ptrPS,
		REFPROPERTYKEY key,
		LONG value)
	{
		PROPVARIANT pv;
	...
	int32_t AudioCaptureCore::_RefreshDeviceList(EDataFlow dir)
	{
	...
	int16_t AudioCaptureCore::_DeviceListCount(EDataFlow dir)
	{
		WEBRTC_TRACE(kTraceInfo, kTraceAudioDevice, _id, "%s", __FUNCTION__);
	...
	int32_t AudioCaptureCore::_GetListDeviceName(EDataFlow dir, int index, LPWSTR szBuffer, int bufferLen)
	{
		WEBRTC_TRACE(kTraceInfo, kTraceAudioDevice, _id, "%s", __FUNCTION__);
	...
	int32_t AudioCaptureCore::_GetDefaultDeviceName(EDataFlow dir, ERole role, LPWSTR szBuffer, int bufferLen)
	{
		WEBRTC_TRACE(kTraceInfo, kTraceAudioDevice, _id, "%s", __FUNCTION__);
	...
	int32_t AudioCaptureCore::_GetListDeviceID(EDataFlow dir, int index, LPWSTR szBuffer, int bufferLen)
	{
		WEBRTC_TRACE(kTraceInfo, kTraceAudioDevice, _id, "%s", __FUNCTION__);
	...
	int32_t AudioCaptureCore::_GetDefaultDeviceID(EDataFlow dir, ERole role, LPWSTR szBuffer, int bufferLen)
	{
		WEBRTC_TRACE(kTraceInfo, kTraceAudioDevice, _id, "%s", __FUNCTION__);
	...
	int32_t AudioCaptureCore::_GetDefaultDeviceIndex(EDataFlow dir,
		ERole role,
		int* index)
	{
		WEBRTC_TRACE(kTraceInfo, kTraceAudioDevice, _id, "%s", __FUNCTION__);
	...
	int32_t AudioCaptureCore::_GetDeviceName(IMMDevice* pDevice,
		LPWSTR pszBuffer,
		int bufferLen)
	{
		WEBRTC_TRACE(kTraceInfo, kTraceAudioDevice, _id, "%s", __FUNCTION__);
	...
	int32_t AudioCaptureCore::_GetDeviceID(IMMDevice* pDevice, LPWSTR pszBuffer, int bufferLen)
	{
		WEBRTC_TRACE(kTraceInfo, kTraceAudioDevice, _id, "%s", __FUNCTION__);
	...
	int32_t AudioCaptureCore::_GetDefaultDevice(EDataFlow dir, ERole role, IMMDevice** ppDevice)
	{
		WEBRTC_TRACE(kTraceInfo, kTraceAudioDevice, _id, "%s", __FUNCTION__);
	...
	int32_t AudioCaptureCore::_GetListDevice(EDataFlow dir, int index, IMMDevice** ppDevice)
	{
		HRESULT hr(S_OK);
	...
	int32_t AudioCaptureCore::_EnumerateEndpointDevicesAll(EDataFlow dataFlow) const
	{
		WEBRTC_TRACE(kTraceInfo, kTraceAudioDevice, _id, "%s", __FUNCTION__);
	...
	void AudioCaptureCore::_TraceCOMError(HRESULT hr) const
	{
	...
	char* AudioCaptureCore::WideToUTF8(const TCHAR* src) const {
#ifdef UNICODE
	...
	bool AudioCaptureCore::KeyPressed() const {
